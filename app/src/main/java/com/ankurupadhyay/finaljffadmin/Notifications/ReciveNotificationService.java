package com.ankurupadhyay.finaljffadmin.Notifications;
...
public class ReciveNotificationService extends FirebaseMessagingService {
    ...
    private void sendNotification(RemoteMessage remoteMessage)
    {
        ...
        if (sharedPreferences.getString(Common.SP_TYPE,"na").equals("Admin")) {
            ...
            myIntent= new Intent(getApplicationContext(), DeliveryBoyHomeActivity.class);
        }
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                ...
                {
                    resultIntent = new Intent(getApplicationContext(), DeliveryBoyHomeActivity.class);
                }
