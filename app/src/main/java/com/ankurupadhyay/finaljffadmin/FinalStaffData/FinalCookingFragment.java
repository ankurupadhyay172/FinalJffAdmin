...
public class FinalCookingFragment extends Fragment {


    public FinalCookingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_final_cooking, container, false);
        ...
        db.collection(Common.Purchased_Db).whereEqualTo("status","Cooking").orderBy("timestamp", Query.Direction.DESCENDING).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                }else
                {
                    ...
                    if (list.size()<=0)
                    {
                        ...
                        status.setText("No Cooking Orders");
                    }
