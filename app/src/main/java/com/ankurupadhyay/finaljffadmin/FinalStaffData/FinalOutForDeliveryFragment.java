...
public class FinalOutForDeliveryFragment extends Fragment {


    public FinalOutForDeliveryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_final_out_for_delivery, container, false);
        ...
        db.collection(Common.Purchased_Db).whereEqualTo("status","Out for delivery").orderBy("timestamp", Query.Direction.DESCENDING).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                }else
                {
                    ...
                    if (list.size()<=0)
                    {
                        ...
                        status.setText("No Out For Delivery");
                    }
