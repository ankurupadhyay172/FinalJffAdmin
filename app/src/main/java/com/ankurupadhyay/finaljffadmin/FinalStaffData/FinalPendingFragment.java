...
public class FinalPendingFragment extends Fragment {

    public FinalPendingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_final_pending, container, false);
        ...
        db.collection(Common.Purchased_Db).whereEqualTo("status","Pending").orderBy("timestamp", Query.Direction.DESCENDING).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
