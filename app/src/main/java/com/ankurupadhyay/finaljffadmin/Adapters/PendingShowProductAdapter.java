...
import com.ankurupadhyay.finaljffadmin.AddOrder.PendingSubCategoryActivity;
...
public class PendingShowProductAdapter extends RecyclerView.Adapter<PendingShowProductAdapter.MyViewHolder>{

    Context context;

    List<HomeMenuModel> list;

    public PendingShowProductAdapter(Context context, List<HomeMenuModel> list) {
